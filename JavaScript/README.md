...
## Chapter 1: Variables  
Introduction to JavaScript basics: variables (`let`, `const`, `var`), numbers, arithmetic operators, operator precedence, data types, strings, booleans, null & undefined, indexing, and simple console operations.  
